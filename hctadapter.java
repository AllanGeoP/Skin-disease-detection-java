...
public class hctadapter extends RecyclerView.Adapter<hctadapter.MyViewHolder>{

    private LayoutInflater inflater;
    private ArrayList<hctmodel> dataModelArrayList;
    private Context c;

    public hctadapter(Context ctx, ArrayList<hctmodel> dataModelArrayList){
        c = ctx;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.hct, parent, false);
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            super(itemView);
            cardView = itemView.findViewById(R.id.hctcardview);
            textView1 = itemView.findViewById(R.id.hctname);
            image = itemView.findViewById(R.id.hctimg);
        }
    }
}
